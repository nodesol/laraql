...
class ScoutFiltersDirective extends ScoutFiltersBaseDirective
{
    public static function definition(): string
    {
        return /** @lang GraphQL */ <<<'GRAPHQL'
"""
Add a dynamically client-controlled Scout Filters to a fields query.
"""
directive @scoutFilters(
    """
    ...
    Expected signature: `(
        ...
        array<string, mixed> $scoutFilters
    ): void`

    Consists of two parts: a class name and a method name, separated by an `@` symbol.
    If you pass only a class name, the method name defaults to `__invoke`.
    """
    handler: String = "\\Nodesol\\LaraQL\\ScoutFilters\\ScoutFiltersHandler"
